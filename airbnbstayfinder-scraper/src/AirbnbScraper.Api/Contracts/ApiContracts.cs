...
public sealed record PySearchListingResponse
{
    ...
    public object? PassportData { get; init; }

    [JsonPropertyName("paymentMessages")]
    public object? PaymentMessages { get; init; }

    [JsonPropertyName("price")]
    public PyPriceDto Price { get; init; } = new();

    [JsonPropertyName("rating")]
    public PyRatingDto Rating { get; init; } = new();

    [JsonPropertyName("images")]
    public IReadOnlyList<PyImageDto> Images { get; init; } = [];

    [JsonPropertyName("badges")]
    public IReadOnlyList<string> Badges { get; init; } = [];

    [JsonPropertyName("coordinates")]
    public PyCoordinatesDto? Coordinates { get; init; }
}

public sealed record PyPassportDataDto
{
    [JsonPropertyName("name")]
    public string? Name { get; init; }
    ...
    [JsonPropertyName("ratingAvarage")]
    public double RatingAverage { get; init; }
}

public sealed record PyPaymentMessageDto
{
    [JsonPropertyName("__typename")]
    public string TypeName { get; init; } = "PaymentMessage";
...
public sealed record PyPriceDto
{
    [JsonPropertyName("unit")]
    public PyPriceUnitDto Unit { get; init; } = new();

    [JsonPropertyName("total")]
    public PyPriceTotalDto Total { get; init; } = new();
}

public sealed record PyPriceUnitDto
{
    [JsonPropertyName("qualifier")]
    public string Qualifier { get; init; } = "total";

    [JsonPropertyName("curency_symbol")]
...
public sealed record PyPriceTotalDto
{
...
public sealed record PyRatingDto
{
...
public sealed record PyImageDto
{
    [JsonPropertyName("url")]
    public string? Url { get; init; }
}

public sealed record PyCoordinatesDto
{
